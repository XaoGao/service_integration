RSpec.describe Settings::Seller do
  ...
  describe ".header_for_work_day" do
    context "when interval is found" do
      ...
      it { expect(seller.header_for_work_day).to be_a(Settings::Account) }
    end
  end
  ...
  describe ".account_by_interval" do
    context "when work day is true" do
      ...
      it { expect(seller.account_by_interval(true)).to be_a(Settings::Account) }
    end
    ...
    context "when work day is false" do
      ...
      it { expect(seller.account_by_interval(false)).to be_a(Settings::Account) }
    end
  end
  ...
  describe ".account" do
    ...
    it { expect(seller.account).to be_a(Settings::Account) }
  end
end
